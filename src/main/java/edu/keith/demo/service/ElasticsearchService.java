package edu.keith.demo.service;
...
//        elasticsearchTemplate.putMapping(NewsInfo.class);
    ...
    public boolean updateWithVersion(TaskInfo taskInfo, Long version) {
        try {
            UpdateRequestBuilder updateRequestBuilder = client.prepareUpdate().setVersion(version);
    ...
    * @return
    ...
    public List<Map<String, Object>> queryForObjectForElasticSerch(String type,
        ...
        reqBuilder.setQuery(QueryBuilders.filteredQuery(queryString, new RangeQueryBuilder("taskState").from(start).to(end)))
                .setExplain(true);
